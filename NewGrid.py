...
MarginSize = 2  #Size of spaaace between the Squares
SquareList = []
...
class GridWidget(Widget):
    def __init__(self, **kwargs):
        ...
        global StartSquarePos, EndSquarePos
        rawStartCoord = Window.width / 3  #Put it 1/3 the way in visual spaaace horizontally
        rawEndCoord = Window.width * 2 / 3  #Same as above, but 2/3 horizontally
        rawHeight = Window.height / 2  #Put both halfway in visual spaaace
